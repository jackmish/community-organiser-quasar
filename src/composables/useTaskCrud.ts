...
export function useTaskCrud(args: {
  ...
  const handleUpdateTask = async (updatedTask: any) => {
    ...
    const updated = (allTasks.value || []).find((t: any) => t.id === updatedTask.id) || null;
...
/** @deprecated Import from src/composables/useTaskCrud instead. */
export const createTaskCrudHandlers = useTaskCrud;
