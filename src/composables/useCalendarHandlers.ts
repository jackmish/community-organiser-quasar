...
export function useCalendarHandlers(args: {
...
/** @deprecated Import from src/composables/useCalendarHandlers instead. */
export const createCalendarHandlers = useCalendarHandlers;
