export function useLineEventHandlers() {
...
/** @deprecated Import from src/composables/useLineEventHandlers instead. */
export const createLineEventHandlers = useLineEventHandlers;
