...
days[today] = {
  ...
  tasks: [
    ...
    {
      id: 't-15',
      name: 'Important list of house fixes',
      description:
        'House fixes\n- Paint fence\n- [x] Test 1\n-[x]Test 2- [x] Test3\n-[x]Fix faucet- [x] Test4\n-[x]Fix faucet',
      date: today,
      priority: 'high',
      status_id: 1,
      type_id: 'Todo',
    ...
    {
      id: 't-15-b',
      name: 'Small things to do',
      description:
        'Small things to do\n-move tool box\n-[x] Replace light bulb- [x] Replace light bulb\n- [x] Clean gutters\n-[x]Fix faucet',
      date: today,
      priority: 'low',
      status_id: 1,
      type_id: 'Todo',
    ...
    },
    {
      id: 't-refill-soap',
      name: 'Refill soap',
      description: 'Refill liquid soap in bathroom and kitchen',
      date: today,
      priority: 'low',
      status_id: 1,
      type_id: 'Replenish',
    ...
    },
    {
      id: 't-buy-soap',
      name: 'Buy soap',
      description: 'Buy liquid soap for family bathrooms',
      date: today,
      priority: 'low',
      status_id: 1,
      type_id: 'Replenish',
    ...
    },
    {
      id: 't-water-plants',
      name: 'Water plants',
      description: 'Water indoor plants (recurring every 14 days)',
      date: today,
      priority: 'medium',
      status_id: 1,
      type_id: 'TimeEvent',
      ...
      groupId: 'g-house',
      repeatMode: 'cyclic',
      repeatCycleType: 'other',
      repeat: { cycleType: 'other', intervalDays: 14 },
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: 't-car-refill-sprinklers',
      name: 'Refill sprinklers',
      description: 'Top up the sprinkler reservoir and check timers',
      date: today,
      priority: 'medium',
      status_id: 1,
      type_id: 'Replenish',
    ...
    },
    {
      id: 't-car-wash',
      name: 'Car wash',
      description: 'Wash Car 1 and clean interior',
      date: today,
      priority: 'low',
      status_id: 1,
      type_id: 'Replenish',
    ...
    {
      id: 't-car-refuel-petrol',
      name: 'Refuel petrol',
      description: 'Refuel Car 1 (petrol) to at least 3/4 tank',
      date: today,
      priority: 'medium',
      status_id: 1,
      type_id: 'Replenish',
    ...
    },
    {
      id: 't-done-2',
      name: 'Fix faucet',
      description: 'Repaired the kitchen faucet',
      date: today,
      priority: 'medium',
      status_id: 0,
      type_id: 'Todo',
...
days[day3] = {
  ...
  tasks: [
    ...
    // Completed sample task for day3
    {
      id: 't-done-3',
      name: 'Practice',
      description: 'Practicing scales',
      date: day3,
      priority: 'low',
      status_id: 0,
      type_id: 'Todo',
...
days[lastDayIso].tasks.push({
  id: 't-taxes',
  name: 'Taxes deadline',
  description: 'Taxes deadline\nSubmit tax documents before the deadline',
  date: lastDayIso,
  // eventTime: '09:00',
  priority: 'critical',
  status_id: 1,
